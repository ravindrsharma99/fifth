        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="cateGORy_contenT_PEnal text-center">
                    ...
                    <h3><?php echo $category->sub_cat; ?></h3>
                </div>
            </div>
        </div>
        <hr>
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="penal_detl_BOx bG_Whit">
                    ...
                    <span class="penal_detl_BOx_DATEAuto pull-right TIME_text" id="dt1">
                        <?php print_r($_SESSION['review_data']['distance']);echo "Kilometers"; ?><?php print_r($_SESSION['review_quote_data']['booking_date']); ?>
                    </span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="penal_detl_BOx bG_Whit">
                    ...
                    <span class="penal_detl_BOx_timeAuto pull-right TIME_text" id="tm1">
                        <?php print_r($_SESSION['review_data']['hours']); echo " Minutes"; ?><?php print_r($_SESSION['review_quote_data']['booking_time']); ?>
                    </span>
