<?php 
   // print_r($show->services);
    
    // print_r($brk);die;
    // $name 
    // $service0 = $brk[0]->totalprice;
    // $service1 = $brk[1]->totalprice;
    // $service2 = $brk[2]->totalprice;
    //print_r($service0);die;
?>
<style>
.design{color:#2b92df;}
</style>
<div class="panel_Custom">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="cateGORy_contenT_PEnal text-center">
                <h5>sub Category</h5>
                <div class="cateGORy_img_box">
                    <img src="<?php echo $category->imagee; ?>">
                </div>
                <h3><?php echo $category->subCategoryName; ?></h3>
            </div>
        </div>
    </div>
            ...
            <div class="date_time">
                <ul>
                    <li>
                        ...
                        <p class="distence_new"><?php echo $show->distance ; ?> killometter</p>
                    </li>
                    <li>
                        <span><img src="<?php echo base_url(); ?>assests/images/ic_time_distance.png"></span>
                        <p class="distence_new"><?php echo $show->time; ?> Minutes</p>
            ...
            <div class="date_time" id="datetimepicker">
                <ul>
                    <li><span><img src="<?php echo base_url(); ?>assests/images/datepicer.png"></span>
                        <?php $newDate = date("d-m-Y", strtotime($show->booking_date)); echo $newDate; ?>
                    </li>
    ...
    <div class="row">
        ...
        <!-- <?php }elseif($show->status == 4 && $show->is_quote == 1){ ?>
            <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="unbooked">
                <p>###########</p>
                <div class="check">
    ...
    <div class="row">
        <div class="HADING_TITTLE">
            ...
            <div class="col-md-8 col-sm-8">
                <div class="contact_info">
                    <ul>
                        <li><span class="providr_image"><img src="<?php echo $driver->profile_pic; ?>"></span>
    ...
    <div class="row">
        <div class="HADING_TITTLE">
            ...
            <div class="col-md-8 col-sm-8">
                <div class="contact_info">
                    <ul>
                        <li><span class="providr_image">
                            <img src="<?php echo $driver->profile_pic; ?>">
                            <!-- <img src="<?php echo base_url(); ?>assests/images/usser.png"> -->
                            </span>
                                <input type="text" value="<?php echo $driver->fname .' '. $driver->lname ; ?>" readonly="readonly">
                        </li>
                       <!--  <li></li> -->
    ...
    <?php $check_rating = $rating->rating; if(empty($check_rating)){ ?>
    ...
    <?php }else{ 
            //echo "<h4> You rated </h4>" .$check_rating; 
        } ?>
