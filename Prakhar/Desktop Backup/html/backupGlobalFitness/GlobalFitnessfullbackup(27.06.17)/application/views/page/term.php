<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">                  
               <header class="panel-heading">Terms of Service</header>              
          <div class="panel-body">
            ...
            <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'];; ?>" method="post">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label col-sm-2">Terms of Service Content</label>
                  <div class="col-sm-10">
                      <textarea class="form-control ckeditor" name="content" rows="40"><?php echo $result[0]->Content; ?></textarea>
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">                   
                    <button type="submit" value="<?php print_r($result[0]->Id); ?>" name="updateid" class="btn btn-danger">Update</button> 
                  </div>
                </div>  
