...
<head>
   ...
   <!--  <link rel="stylesheet" href="<?php echo base_url(); ?>assests/css/bootstrap-material-datetimepicker.css" /> -->
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/css/jquery-rating.css'); ?>"/>
    <!-- <style type="text/css" src=""></style> -->
<script type="text/javascript" src = "<?php echo base_url('public/js/jquery-rating.js'); ?>"></script>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <li><a href="<?php echo base_url(); ?>index.php/Booking/setting">About Us</a></li>
                                                <li>                                             
