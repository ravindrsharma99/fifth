                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="loaction">
                               ...
                               <div class="loaction displaynone" id ="waypoint_charge">
                                <div class="col-md-6 col-sm-6">
                                    <div class="est">
                                        <h3><span><img src="<?php echo base_url(); ?>assests/images/esT.png"></span>WAYPOINT CHARGE</h3>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="est">
                                        <h4>$<input type="hidden" id="waypoint" name="estprice" value=""><span id="waypointcharge">0</span></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="loaction">
        ...
        j.ajax({
            ...
            success: function(html) {
                ...
                if (html == "error") {
                    ...
                    $('#sub3').show();
                    $('#hh').html(html);
                    var z= $("#sub1").find('option:selected').attr("name");
                if(z==1){
                    $('#waypoint_charge').removeClass('displaynone');
                }else{
                    $('#waypoint_charge').addClass('displaynone');
                }
              }
            }
        });
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            $('#addnew').click(function() {
                alert('By Adding Waypoint this will cost you extra charge for each waypoint added by you');
                if(i < 11){
        ...
        <button class="btn btn-success displaynone"  id="stlc" onclick="selectStart()">Start Location</button>
        ...
        <button class="btn btn-success displaynone"  id="btn"  onclick="myfntn(this)" data-dismiss="modal" value="confirm">Confirm</button>
            <input type="hidden" id="wyrs" value="">
        <button class="btn btn-success "  id="btnn" data-dismiss="modal" value="confirm">Confirm</button>
    </div>
</div>
</body>
<script type="text/javascript">
