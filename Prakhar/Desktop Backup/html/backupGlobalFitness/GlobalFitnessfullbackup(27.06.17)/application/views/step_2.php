				...
				$totalWeight=0;
            	 for($i=0; $i<$_SESSION['productDetail']['count'];$i++){
			        ...
			        foreach($product as $live){
			        	$thisPrice = $_SESSION['sale'][$i]*trim($live->Price,'$');
					    ...
					    <div class="col-md-3 col-sm-4 col-xs-8">
							...
							<div class="joint_penal_group">
							  <div class="joint_one">
									...
									<div class="parice_check_total"><?php echo trim($live->Price,'$'); ?></div>
							   </div>
							   <div class="joint_one">
...
// print_r($thisWeight);die;
			...
			<div class="joint_penal_group">
			   ...
			   <div class="joint_one">
					...
					<div class="parice_check_total"><?php echo $totalprice; ?></div>
		...
		<div class="row chack_out_one_accordian">
			<div class="col-md-12 col-sm-12">
					<ul id="accordion" class="accordion">
					  <li>
					    <div class="link"><a href="#ShippingDetails" aria-expanded="false" aria-controls="ShippingDetails" class="accordion-title accordionTitle js-accordionTrigger"><span>1</span> Shipping Details</a></div>
								    	...
								    	<div class="shipping_form_penal">
								    		<div class="first_penal_ship">
								    			<div class="form-group">
												  <input type="text" id="firstname" class="form-control firstname" placeholder="First Name">
												</div>
												<div class="form-group_second">
												  <input type="text" id="lastname" class="form-control lastname" placeholder="Last Name">
												</div>
								    		</div>

								    		<div class="second_penal_ship">
								    			<div class="form-group">
												  <input type="text" id="CompanyName" class="form-control firstname" placeholder="Company Name (optional)">
												</div>
								    		</div>

								    		<div class="third_penal_ship">
								    			<div class="form-group_area_cod">
												  <input type="text" id="AreaCode" class="form-control AreaCode" placeholder="Area Code">
												</div>
												<div class="form-group_primary_number">
												  <input type="text" id="PrimaryPhone" class="form-control PrimaryPhone" placeholder="Primary Phone">
												</div>
								    		</div>

								    		<div class="fourth_penal_ship">
								    			<div class="form-group">
												  <input type="text" id="StreetAddress" class="form-control StreetAddress" placeholder="Street Address">
												</div>
								    		</div>
								    		<div class="fourth_penal_ship">
								    			<div class="form-group">
												  <input type="text" id="suite" class="form-control" placeholder="Suite, Bldg, Apt (optional)">
												</div>
								    		</div>
								    		...
								    		<div class="fifth_penal_ship">
								    			<div class="form-group_city">
												        <select class="form-control" placeholder="state" id="state">
													        <option>state</option>
													        <option value="LA">LA</option>
													        <option value="OH">Ohaio</option>
													        <option value="WI">WI</option>
													        <option value="HL">Honululoo</option>
													      </select>
												</div>
						    	...
						    	<div class="row">
								    <div class="col-md-6 col-sm-6">
								    	...
								    	<div class="shipping_form_penal">
								    		...
								    		<div class="second_penal_ship">
								    			<div class="form-group">
												  <input type="text" id="EmailAddress" class="form-control EmailAddress" placeholder="Email Address">
												</div>
								    		</div>
								    	</div>
										...
										<div class="shipping_form_penal">
											...
											<div class="second_penal_ship">
								    			<div class="form-group">
												  <input type="text" placeholder="Company Name (optional)" class="form-control firstname" id="CompanyName">
												</div>
								    		</div>
								    		...
								    		<div class="fifth_penal_ship">
								    			<div class="form-group_city">
												        <select class="form-control" placeholder="City" id="city">
												            <option>City</option>
													        <option>Shimla</option>
													        <option>Tokiyo</option>
													        <option>Paris</option>
													        <option>Honululoo</option>
													      </select>
												</div>
												<div class="form-group_state">
								    ...
								    <div class="col-md-6 col-sm-6 padd_lot">
								    	...
								    	<div class="payment_chack_prop">
								    		<div class="radio-inline"><input type="radio" name="optradio"></div>
                                  ...
                                  <div class="payment_padding">
						    		<div class="payment_penal_ship">
										...
										<div class="form-group_SecurityCode">
										  <input type="text" id="SecurityCode" class="form-control" placeholder="Security Code">
										</div>
										<span>?</span>
						    		</div>
						    		...
						    		<div class="payment_penal_ship">
						    			...
						    			<input type="text" id="mounth" class="form-control" placeholder="Month">
										</div>
										<div class="form-group_year_expire">
										  <input type="text" id="SecurityCode" class="form-control" placeholder="Year">
										</div>
										<div class="expirecrd">Expires?</div>
						    		</div>
						    	  </div>
									...
									<div class="col-md-12 col-sm-12">
									  	<div class="row align_right ">
									  		<div class="col-md-4 col-sm-5 col-md-offset-8">
												<div class="chat_and_chack opn_res">
													<div class="chat"><a href="">Chat Now</a></div>
													<div class="chackout_box_buton"><a href="">Continue</a></div>
												</div>
											</div>
										</div>
									</div>
	    ...
	    <div class="row Chack_out_question">
			<div class="col-md-12 col-sm-12">
				<div class="chackout_penal_heading">
				    <h3>Questions</h3>
				</div>
		...
		<div class="row Chack_out_question_content mobile_off">
			<div class="col-md-6 col-sm-6">
...
<script>
// shipingDetails
$('#shipingDetails').on('click', function(e)
{
	e.preventDefault();
