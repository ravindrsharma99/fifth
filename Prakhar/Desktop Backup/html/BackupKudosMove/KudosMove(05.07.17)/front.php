    ...
    $(document).ready(function() {
        ...
        // alert('its me');
            if($("#exampleInputEmail").val() == '') {
                ...
                $('#error_msg_forgot_pass').text('Please Enter Email Address');
                return false;
            }   else{                           
                            $("#forgot_form").submit();
                        }
...
<span id ="error_msg_forgot_pass" style="color: red;" ></span>
                    <div class="modal-body">
                        <form role="form" method="post" id="forgot_form" action="" class="form-horizontal">
                            <div class="form-group row FORGET_EMAIL">
                                <label class="control-label col-md-3" for="exampleInputEmail" style="text-align:left;">
                                    Email Address
                                </label>
                                <input type="email" class="form-control col-md-7" id="exampleInputEmail" required name="forgot_email" placeholder="Enter email">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="submit" name="forgot_password_submit" value="Submit" id="forgot_pass_submit" class="btn SUBmitt_button">
                                </div>
                            </div> 
                        </form>
