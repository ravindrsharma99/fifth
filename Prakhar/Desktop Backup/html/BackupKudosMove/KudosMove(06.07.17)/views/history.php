                                ...
                                <div class="old_welt_history_content">
                                    <div class="DAte_penal1">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h5 class="pull-left"><?php
                                            $time = $his->date_created ;
                                ...
                                <div class="old_welt_history_content">
                                    <div class="DAte_penal1">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h5 class="pull-left">
                                                <?php 
                                                $time = $his1->booking_date.' '.$his1->booking_time ;
                                                $utc_ts = strtotime($time);
                                                $offset = date("Z");
                                ...
                                <div class="old_welt_history_content">
                                    <div class="DAte_penal1">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h5 class="pull-left">
                                            <?php
                                                $time = $his2->booking_date.' '.$his2->booking_time ;
                                                $utc_ts = strtotime($time);
                                                $offset = date("Z");
                                                $local_ts = $utc_ts + $offset;
                                                $local_time = date("Y-m-d g:i A", $local_ts); 
                                ...
                                <div class="old_welt_history_content">
                                    <div class="DAte_penal1">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h5 class="pull-left">
                                                <?php
                                                  $time = $his3->booking_date.' '.$his3->booking_time ;
                                                $utc_ts = strtotime($time);
                                                $offset = date("Z");
                                                $local_ts = $utc_ts + $offset;
                                                $local_time = date("Y-m-d g:i A", $local_ts); 
