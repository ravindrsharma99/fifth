                ...
                <div class="panel_Custom">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                           <!--  <div class="date_time" id="datetimepicker">
                            ...
                            <div class='input-group date' >
                                <input type='text' class="form-control" readonly required id='datetimepicker6'/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 labl">
                            ...
                            <div class="loaction">
                                ...
                                <a onclick="mydata();" type="hidden" class="fb" data-toggle="modal" data-target="#myModal">
                                    <input type="text" id="start_location_outer" name="pickup_location_val1" required/>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 labl" id="hidee">
                            ...
                            <div class="loaction">
                                <input type="text" id="end_location_outer" readonly="readonly" name="location1" required>
                            </div>
                        </div>
                           <div class="row1">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="loaction">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="est">
                                        <h4>$<input type="hidden" id="spann2" name="estprice" value=""><span id="spann1"></span></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="loaction">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="est">
                                        <h4><input type="hidden" id="txt" name="extrafea" value="">$<span id="total"></span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
var delete_id = $(elem).val();
    ...
    if (alt == "") {
      ...
      data: 'val=' + st + '&origin=' + origin + '&destination=' + destination + '&inc=' + i,
