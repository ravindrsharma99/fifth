      ...
      <div class="col-lg-12">
        <section class="panel">                  
          ...
          <div class="panel-body">
             ...
             <form class="form-horizontal" action="<?php echo base_url('/dashboard/shop'); ?>/<?php echo $name; ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label col-sm-2"><?php echo $name; ?> Content</label>
                  <div class="col-sm-10">
