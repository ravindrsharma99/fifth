          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" role="form" >
              <div class="form-group">
                  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">PieceID</label>
                  <div class="col-lg-5">
                
                    <select name="PieceID" class="form-control m-bot15">
                     <?php
                        foreach($Piece as $p){
              ...
              <div class="form-group">
                  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">TrainingZoneID</label>
                  <div class="col-lg-5">
                   
                    <select name="TrainingZoneID" class="form-control m-bot15">
                     <?php
                        foreach($tz as $t){
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input required placeholder=" e.x. 325 (enter only the number no special characters or Undiscolsed) *Max of 10 Numbers" type="number" class="form-control" id="inputPassword1" name="WeightStackCapacity" >
                  </div>
              </div>
              <div class="form-group">
