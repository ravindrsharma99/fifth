    ...
    $('#btnn').click(function() {
        ...
        j.ajax({
            ...
            success: function(result) {
                ...
                $path_way = $ar.key3;
                $path_time = $ar.key4;
                // if($distance == 0 || $resultss == 0){
                //         alert('Please select correct destination');
                //          $zero11 = '';
                //         $('#start_location_outer' ).val($zero11);
                //         $('#end_location_outer' ).val($zero11);
                //         $('#distancekm' ).val($zero11);
                //         $('#time123' ).val($zero11);
                //         $('#spann1' ).html('0');
                //         $('#spann2' ).val('0');
                //         return false;
...
function myfunction1() {
    // alert('i am working');return false;
