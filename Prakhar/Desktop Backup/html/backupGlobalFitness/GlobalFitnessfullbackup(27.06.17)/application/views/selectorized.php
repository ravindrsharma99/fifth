...
<section class="TABLE_PRODUCT_PAGE_Penal">
    <div class="container-fluid">
      <div class="row PADD_ThREee">
         <div class="select-style Filter_BUTTn_Reste PaginatedSelectorized_page">
              <?php   $link  = str_replace("-", "*",$category_name);
                 $link  = str_replace(" ", "-",$link);
                 $link  = strtolower($link);
                if(isset($filter_check)){
                if($filter_check=="Strength"){
                    ?>
                     <a rel="nofollow" href="<?php echo base_url('/gym-equipment/filters/'.$link."?brand=precor"); ?>"><span class="glyphicon glyphicon-filter"></span> Filter</a>
                    <?php
                  }
                  else{
                    ?>
                     <a rel="nofollow" href="<?php echo base_url('/fitness-equipment/filters/'.$link."?brand=precor"); ?>"><span class="glyphicon glyphicon-filter"></span> Filter</a>
                    <?php
                  }
                }elseif(isset($mycategory) && $strength_equipment == 'brand'){
                        ?>
                         <a rel="nofollow" href="<?php echo base_url('/brand/filters').'/'.$link; ?>"><span class="glyphicon glyphicon-filter"></span> Filter</a>
                        <?php
                }
                        ...
                        ?>
                         <a rel="nofollow" href="<?php echo base_url('gym-accessories/filters/'.$link); ?>"><span class="glyphicon glyphicon-filter"></span> Filter</a> <?php
                } ?>
          </div>
          <div class="inner_accordian_arrow PaginatedSelectorized_page_PENAL">
              <?php
                if(isset($_GET)){
                      ...
                      $params = array();
                       $k = 0 ;
                        ...
                        <?php if(isset($getcategory)){ ?>
                                <dt class="respon">
                                  <h1 class="accordion-title accordionTitle js-accordionTrigger ACCORDIan_H_ONE" aria-controls="accordion1" aria-expanded="false" href="#accordion1"><?php echo $category_name;  ?>
                                <div class="arrw"><span class="bar top"></span><span class="bar bottom"></span></div></h1>
                                 </dt>
    ...
    <div class="container-fluid ">
      <div class="row PADD_ThREee TABLE_PRODUCT_WRAPER  TABLE_WEBVIEw_CLASS CATEGORY_PAGgg_PENAL">
                              ...
                              <td>
                                  <p class="PRO_IMggd">
                                        <?php if($ptype=="0" || $products->Kingdom == 'Cardio' ){
                                              ?>   <i><a href="<?php echo base_url('gym-equipment/filters').'/selectorized-station?brand='.$lower; ?>">
                                                <img alt="<?php echo $products->Expr1; ?>" title="<?php echo $products->MetaDetailPageTitleTag; ?>"
                                                 src="<?php echo base_url().'/'.$products->ImageURL; ?>" /></a></i>
                                              <?php
                                            }
                                            else{
                                              ?><i><a href="<?php echo base_url('gym-equipment/filters').'/selectorized-station?brand='.$lower; ?>"><img alt="<?php echo $products->Expr1; ?>" title="<?php echo $products->MetaDetailPageTitleTag; ?>"  src="<?php echo base_url().'/'.$products->ImageURL; ?>" /></a></i>
                                              <?php
                                            }
                                        ?>
                                  ...
                                  <p class="PRO_TEtille"><?php print_r($products->Expr1); ?></p>
  ...
  <span class="rating" data-rating="<?php echo $hello; ?>" data-star="★★★★★"></span>
                               ...
                               <!--    <p >
                                      <div class="STArre">  <input id="input-21b" class="rating" data-min="0" data-max="5" data-step="1" value='<?php echo $avg_rate; ?>' data-disabled="true" data-size="xs" data-show-clear="false" data-show-caption="false" ></div></p> -->
                        ...
                        ?>
                          ...
                          ?>
                              <td>
                                  <p class="PRO_IMggd">
                                        <?php if($ptype=="0" || $products->Kingdom == 'Cardio' ){
                                              ?>   <i><a href="<?php echo base_url('gym-equipment/filters').'/selectorized-station?brand='.$products->BrandName; ?>">
                                                <img alt="<?php echo $products->Expr1; ?>" title="<?php echo $products->MetaDetailPageTitleTag; ?>"
                                                 src="<?php echo base_url().'/'.$products->ImageURL; ?>" /></a></i>
                                              <?php
                                            }
                                            else{
                                              ?><i><a href="<?php echo base_url('gym-equipment/filters').'/selectorized-station?brand='.$products->BrandName; ?>"><img alt="<?php echo $products->Expr1; ?>" title="<?php echo $products->MetaDetailPageTitleTag; ?>"  src="<?php echo base_url().'/'.$products->ImageURL; ?>" /></a></i>
                                              <?php
                                            }
                                        ?>
