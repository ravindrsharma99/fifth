                ...
                <div class="paddingg">
                    ...
                    <div class="modal-body">
                        ...
                        <form method='post' name='email_m' id='email_m'>
                            ...
                            <textarea name="message" id='message' required>Hi There! I am inquiring about a price on this
                                <?php if(isset($detail[0]->ProductName)){ echo  $detail[0]->ProductName ; } ?>, can you please contact me with this information?</textarea>
                    ...
                    <div class="modal-body">
                        ...
                        <form method='post' name='SellProduct' id='SellProduct'>
                            ...
                            <textarea name="message_SellProduct" id='message_SellProduct' required>Hi There!&#13;&#10; I have a "
                                <?php if(isset($detail[0]->ProductName)){ echo  $detail[0]->ProductName ; } ?>" that I need to turn into cash&#13;&#10;Are you interested in purchasing it from me?&#13;&#10;Thanks</textarea>
