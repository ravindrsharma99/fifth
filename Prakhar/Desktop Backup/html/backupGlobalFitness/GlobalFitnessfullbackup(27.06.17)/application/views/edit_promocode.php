          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" role="form" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input required placeholder="Coupon Code" type="text" class="form-control" id="CoupnCode" name="CoupnCode" value ="<?php print_r($value[0]->CoupnCode);?>" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    ...
                    value ="<?php print_r($value[0]->CouponName);?>"  type="text" class="form-control" id="CouponName" name="CouponName" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-8">
                      <textarea required name="CouponDescription" onKeyDown="limitText(this.form.Description,this.form.countdown,500);" onKeyUp="limitText(this.form.Description,this.form.countdown,500);"  placeholder="Approximately 500 Words, no HTML or special charactors" class="form-control" cols="60" rows="5"><?php print_r($value[0]->CouponDescription);?></textarea>
...
You have <input readonly type="text" size="3" value="500"> characters left.</font>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input required placeholder="" value ="<?php print_r($value[0]->CouponStartDate);?>"  type="text" class="form-control some_class" id="CouponStartDate" name="CouponStartDate" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input required placeholder=""  value ="<?php print_r($value[0]->CouponEndDate);?>"   type="text" class="form-control some_class1" id="EndDate" name="CouponEndDate" >
                  </div>
              </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->PercentOff);?>"  type="text" class="form-control" id="szCode" name="PercentOff" >
                  </div>
              </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->DollarOff);?>"  type="text" class="form-control" id="scCode" name="DollarOff" >
                  </div>
              </div> 
                <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->ContingentLimit);?>"   type="text" class="form-control" id="ntCode" name="ContingentLimit" >
                  </div>
              </div> 
                  <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->ProductListID);?>"  type="text" class="form-control" id="ntCode" name="ProductListID" >
                  </div>
              </div> 
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->ProductCategory);?>"  type="text" class="form-control" id="ntCode" name="ProductCategory" >
                  </div>
              </div> 
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input  placeholder="" value ="<?php print_r($value[0]->ProductBrand);?>"  type="text" class="form-control" id="ntCode" name="ProductBrand" >
                  </div>
              </div> 
    <div class="form-group">
