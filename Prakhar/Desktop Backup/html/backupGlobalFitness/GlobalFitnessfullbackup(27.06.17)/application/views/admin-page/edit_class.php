          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" role="form" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input required placeholder="Name only characters" value='<?php echo $val->Name; ?>' type="text" class="form-control" id="Name" name="Name" >
                  </div>
              </div>
              ...
              <div class="form-group">
                 ...
                 <span><a class="btn btn-primary" href='<?php echo base_url("/dashboard/class_list"); ?>'>Back</a></span>
          </div>
        </section>
      </div>
    </div>
