                ...
                <div class="top_brder">
                  <div class="padd-no">
                    <dt class="respon all_center">
                        ...
                        <div class="arrw BFDBFDBD"><span class="bar top"></span><span class="bar bottom"></span></div></a>
                    </dt>
        ...
        <div class="container-fluid">
            <div class="row inner_product_discription ">
                <div class="col-md-6 col-sm-6 img_penal_l all_center">
                    <a href="">
                      <img itemprop="image" src="<?php echo base_url().$detail[0]->ImageURL; ?>"
                       alt=" Image of a <?php echo $detail[0]->ProductName; ?>" title="<?php echo $detail[0]->ProductName; ?>">
                     </a>
                </div>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 all_center">
                              <div class="product_penal_content">
                                  <p>
                                      <?php echo $detail[0]->WarrantyBlurb; ?>
                                  </p>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    ...
                    <ul class="product_inner">
                        <li>
                            <?php echo $detail[0]->Voltage ;  ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Amps ;  ?>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <ul class="product_inner">
                        ...
                        <li>
                            <?php echo $detail[0]->WeightCapacity; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature1st; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature2nd; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature3rd; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature4th; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature5th; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature6th; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature7th; ?>
                        </li>
                        <li>
                            <?php echo $detail[0]->Feature8th; ?>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 col-sm-4">
                    ...
                    <ul class="product_inner">
                        <li>
                            <?php echo $detail[0]->WarrantyDecription; ?>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <!--   <?php if($this->session->userdata('userId')!=''){
                                                ?>
                                              <?php } else{?>
                                            <a data-target="#myModal_login" data-toggle="modal" href="#"><button class='btn btn-default'>Submit</button></a>
                                              <?php } ?> -->
                                </div>
                            </div>
                        </form>
